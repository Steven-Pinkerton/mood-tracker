...
For details, see: https://srid.ca/mood-tracker/start
...
- Run the application without installing: `nix run github:srid/mood-tracker` (or `nix run .` from checkout)
- Common workflows
  - Adding tests: http://srid.ca/mood-tracker/tests
  - Adding Garnix CI: http://srid.ca/mood-tracker/garnix

## Discussions

Got questions? Ideas? Suggestions? Post them here: https://github.com/srid/mood-tracker/discussions
